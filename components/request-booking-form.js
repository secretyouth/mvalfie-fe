                    ...
                    <>
                        ...
                        <div>
                            ...
                            <div className="dropdown">
                                <select name="duration" required onChange={(event) => setForm({ ...form, group_size: event.target.value })}>
                        ...
                        <div>
                            ...
                            <div className="dropdown">
                                <select name="duration" required onChange={(event) => setForm({ ...form, catering: event.target.value })}>
                                    <option value="">Please select...</option>
                                    {/* { data.Durations && data.durations.map((duration) =>
                                    <option value={duration}>{duration}</option>
                                )} */}
                        ...
                        <div className="form-item">
                            ...
                            <div className="dropdown">
                                <select name="duration" required onChange={(event) => setForm({ ...form, location: event.target.value })}>
                                    <option value="">Please select...</option>
                                    {/* { data.Durations && data.durations.map((duration) =>
                                        <option value={duration}>{duration}</option>
                                    )} */}
                        ...
                        <div className="form-item">
                            <label>
                                Boat preference <span>*</span>
                            </label>
                            <div className="dropdown">
                                <select name="duration" required onChange={(event) => setForm({ ...form, boat_preference: event.target.value })}>
                                    <option value="">Please select...</option>
                                    {/* { data.Durations && data.durations.map((duration) =>
                                        <option value={duration}>{duration}</option>
                                    )} */}
                        ...
                        <div className="form-item">
                            <label>Message</label>
                            <textarea name="other" rows="10" onChange={(event) => setForm({ ...form, message: event.target.value })} />
                        </div>
