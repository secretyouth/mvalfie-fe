...
const PrivateHirePage = ({ page, error = '' }) => {
        ...
        <div className={st.container} id="top">
            <Head>
                ...
                <meta
                    ...
                    key="description"
                />
                <meta property="og:url" content={`https://www.mvalfieandco.com.au/private_boat_hires/${page.Page_slug}`} key="og-url" />
...
export async function getServerSideProps({ params }) {
    //console.log(params);
    const pageContent = await api.get(`private-boat-hires?Page_slug=${params.type}`)
