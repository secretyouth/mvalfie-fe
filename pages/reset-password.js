    ...
    return (
        <div className={st.container}>
            <Head>
                ...
                <title key="title">Reset Password | Alfie & Co</title>
                <meta property="og:url" content="https://www.mvalfieandco.com.au/reset-password" key="og-url" />
            </Head>
            ...
            <section className="block-container primary fluid login">
                <div className="blocks">
                    ...
                    <div className="p-5 text-light flex flex-column align-items-start justify-content-center">
